...
``agent_vault_proxy.caching.CachingSecretsClient``.

Design mirrors :mod:`agent_vault_proxy.backends.bws`:
...
annotation verbatim; ``agent_vault_proxy.notes_binding.parse_notes_binding`` turns
...
_log = logging.getLogger("agent_vault_proxy.backends.gsm")
